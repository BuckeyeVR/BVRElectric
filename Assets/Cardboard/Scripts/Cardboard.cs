...
public class Cardboard : MonoBehaviour {
  ...
  //added by savva
  public void setAlignmentMarker(bool b){
		enableAlignmentMarker = b;
		device.SetAlignmentMarkerEnabled (b);

  }
  //added by savva
  public void setSettingsButton(bool b){
		enableSettingsButton = b;
	    device.SetSettingsButtonEnabled (b);
  }
  [SerializeField]
  ...
  public void setSize(CardboardProfile.ScreenSizes s){
		screenSize = s;
		if (device != null) {
			device.UpdateScreenData();
		}	
